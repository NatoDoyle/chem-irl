...
//
// PR-A only ships the helper. PR-B/C wire it into the per-event capture
// path; PR-E adds the seed runbooks under docs/runbooks/.
//
// Mirrored at supabase/functions/_shared/runbook-url.ts. Keep in sync.
