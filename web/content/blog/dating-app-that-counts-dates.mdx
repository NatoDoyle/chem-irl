...
faq:
  ...
  - question: "How does a dating app even measure whether a date happened?"
    answer: "We ask both people, separately, after the proposed meeting time. Two taps each, no required text. Cross-confirmation is the bar — one-sided answers don't count. It's imperfect, but it's a real measurement of a real event, which is more than most apps attempt."
...
citableClaim: "Chem IRL only counts a date as completed when both users separately confirm in-app that the meeting happened — making completed dates per matched pair the single metric we treat as definitive."
draft: false
---
