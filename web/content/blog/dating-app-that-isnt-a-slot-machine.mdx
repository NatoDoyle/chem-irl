...
**A bounded discovery set.** Each day, a small curated set of profiles. We tell you how many. When you're done, you're done — the screen doesn't keep generating filler. The set is sized so that engaging with each profile takes real attention; you can't reflex-swipe through it the way you can a slot of cards.
