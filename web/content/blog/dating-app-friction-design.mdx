...
> **TL;DR.** Sending a low-effort opener takes a beat. Repeated bad behavior costs visibility. But proposing a time, sharing your calendar, or actually meeting up? Frictionless. Chem IRL makes the right things easy and the wrong things expensive — by design. That's friction design, applied to dating, with the asymmetry pointing the way the user's stated goals point.
...
**Visibility loss for flaking.** Cancellations inside the window, no-shows, ghosting active threads — each one moves the Seriousness Score downward. The cost is paid in matches the flaker doesn't see, not in punitive bans. (Read more in [the post on penalizing flaking](/blog/dating-app-that-penalizes-flaking).)
