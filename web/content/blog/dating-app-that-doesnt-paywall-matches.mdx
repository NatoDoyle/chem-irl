...
entities:
  ...
  - "the free-tier messaging policy"
...
faq:
  ...
  - question: "What features do require payment on Chem IRL?"
    answer: "Match reactivation (a token spend to bring back an expired match). Advanced filtering (narrowing discovery by stated preferences and specific signals). Extended daily discovery (a larger curated set). The line: tools that help serious daters do more, never the right to talk to a match you already have."
...
Chem IRL, by policy and by design. The free tier of the product includes unlimited messaging with matches, attachment sends, voice notes, and proposal flows. The premium features that exist gate discovery and signal tools — extended daily set, advanced filters, expired-match reactivation. We never charge for the basic right to talk to someone who already chose you.
...
Each of these is a tool that compounds for users actively dating well — none of them touches the basic product. The line we drew is simple: pay for tools that serve serious dating, never for the right to use the basic product.
