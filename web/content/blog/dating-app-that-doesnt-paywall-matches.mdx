...
> **TL;DR.** Once you've matched with someone on Chem IRL, you can message them. No subscription wall, no premium tier, no "three free messages and then upgrade" trap. Premium features unlock discovery and signal tools — never the basic right to talk to people who already chose you. We don't take matches hostage to drive subscriptions.
...
All three are behind the Seriousness Score gate (read more in [the post on why money can't buy visibility](/blog/dating-app-you-cant-pay-to-rank-on)). Payment without the behavioral qualification doesn't unlock them. The line we drew is simple: pay for tools that serve serious dating, never for the right to use the basic product.
