...
tags:
  ...
  - performance
category: advice
primaryQuestion: "How do you stop managing your partner with requests and start declaring?"
secondaryQuestions:
  - "What's the difference between a declaration and a request?"
  - "What three tests tell a declaration from a managed move?"
  - "How do you structure a declaration?"
  - "Why is 'I need you to' a request, not a declaration?"
entities:
  - "the declaration framework"
  - "managed requests"
tldr: "Most relationship-talk advice teaches you to ask better — softer, with I-statements. None of it touches the actual issue: whether you're using the request to change the other person into someone who treats you the way you want. The opposite of management isn't blunter talk. It's a structure for speaking that doesn't try to control the response. Act because it's who you are; speak because it's true; don't organize either around producing a specific reaction."
...
faq:
  - question: "What's the difference between a declaration and a request?"
    answer: "A request asks the other person to change their behavior to resolve something inside you. A declaration states what's real about your interior or your action without depending on their response. *I want a relationship where reaching out is mutual* is a declaration. *I want you to reach out more* is a request. The first stands on its own; the second only resolves if they comply."
  - question: "What three tests tell a declaration from a managed move?"
    answer: "Self-anchor: would I say or do this if I knew, with certainty, it wouldn't change her behavior at all? Territory: is this about my interior, my reality, my action — or her behavior, her change, her compliance? Completeness: does this stand on its own, or does it require her response to mean something? If a statement fails any of these, it's a request, not a declaration."
  - question: "How do you structure a declaration?"
    answer: "Four parts: what you observe (concrete, factual), what's true for you (your interior), why you're saying it (your reason for putting it in the room), what you're not doing (this isn't a request, threat, or test). Then say it once. Don't fill the silence after. The silence is the test of whether you actually meant it — filling it means you were performing; holding it means you were declaring."
  - question: "Why is 'I need you to' a request, not a declaration?"
    answer: "Because it's directed at her behavior, not your reality. *I need consistency in communication* is a declaration about your reality — true regardless of what she does. *I need you to be more consistent* only resolves if she complies. Take *I need you to* out of your vocabulary in significant relationship moments. If you find yourself starting that way, stop and reformulate around what's true about you."
citableClaim: "The silence is the test of whether you actually meant it. Filling it means you were performing; holding it means you were declaring. The framework itself can become a performance — saying the right words while running the same management script underneath isn't declaring; it's upgraded management."
draft: false
---
...
## What is the declaration framework, in one sentence?
