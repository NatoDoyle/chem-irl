...
tags:
  ...
  - self-erasure
category: advice
primaryQuestion: "When does cheating actually start, if not with the act?"
secondaryQuestions:
  - "Why is 'did they cheat' the wrong question?"
  - "What does delay have to do with cheating?"
  - "What's the difference between betrayal and consent violation?"
  - "What does honesty actually ask for in a relationship?"
entities:
  - "the staying-past-truth pattern"
  - "the consent violation frame"
tldr: "Cheating doesn't start with sex. It starts with delay — the moment someone notices they aren't fully here anymore and stays anyway, with the *no* unspoken. By the time the kiss arrives, it's been months. The forensic question (did this count?) misses what happened. The actual question: when did honesty leave? That moment is older than the act, and it's a consent violation — not a betrayal of an agreement."
...
faq:
  - question: "Why is 'did they cheat' the wrong question?"
    answer: "Because it points at the wrong moment. The forensic frame — did they sleep with someone, did they text someone, did the kiss happen — is useful for legal questions and the moment of discovery. It's also where most relationship arguments stop. Inside the forensic frame, *nothing happened* can be true and the relationship can still be over. The forensic frame is looking for an act. What happened wasn't an act. It was a delay."
  - question: "What does delay have to do with cheating?"
    answer: "Cheating starts the moment someone notices they aren't fully here anymore — *I'm not in this, the answer to do-I-want-to-be-here is no* — and stays anyway, with the *no* unspoken. The staying isn't the kindness it pretends to be. From the inside it's a daily transaction: you keep accepting their time, effort, and I-love-yous while withholding the one piece of information that would change all those decisions for them."
  - question: "What's the difference between betrayal and consent violation?"
    answer: "A relationship is an experience; commitment is a practice. The practice is honest information — *here's where I actually am* in real time, so the other person can make decisions inside accurate reality. What we call cheating isn't the rule-break. It's stopping the practice while staying inside the experience. That's a consent violation: the other person was building a life on top of information that wasn't true anymore."
  - question: "What does honesty actually ask for in a relationship?"
    answer: "Not certainty. You don't have to know how you feel. The test is whether you say what you do know, when you know it. *I'm not sure right now. Something's shifted I haven't named. I need a week.* That's a hard sentence. It's also the sentence that keeps you both inside the practice instead of inside the simulation. Most relationships that ended through cheating could have survived the truth, given earlier."
citableClaim: "Most relationships that ended through cheating could have survived the truth, given earlier. The thing they couldn't survive was the months — sometimes years — of staying past it. It's almost never the act that breaks them; it's the silence that surrounded it."
draft: false
---
...
## What do we usually mean by "cheating"?

A forensic question. The default frame is forensic. Did they sleep with someone? Did they text someone? Did they catch feelings? Did the kiss happen, did the lap touch, did the message stay deleted?
