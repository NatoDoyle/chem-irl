...
**Identity verification artifacts at the third party.** Our verification provider may retain limited records of the verification check, on the timeline mandated by their own KYC and anti-fraud obligations. We don't hold the underlying ID; the third party may, briefly. This is documented in our privacy policy. (See [the verified-daters post](/blog/dating-app-with-verified-daters) for how the verification flow itself works.)
