...
> **TL;DR.** When you leave Chem IRL, your data leaves with you. One-tap account deletion erases your profile, messages, and behavioral history from production systems within a defined window. No "deactivation" purgatory, no shadow profiles, no quiet retention "in case you come back." Gone means gone — and the policy is published, documented, and held to.
