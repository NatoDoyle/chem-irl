...
entities:
  ...
  - "behavior-based discovery weighting"
...
faq:
  - question: "How does Chem IRL's visibility reward work?"
    answer: "When you complete a date — confirmed by both people — and leave honest post-date feedback, your visibility goes up. The reward isn't a notification or a badge; it's a quiet, durable lift in how often you're shown to the kind of people you'd actually want to meet. The system reads what you do and adjusts who sees you."
...
**Visibility lift, not unlock.** Behavior-based discovery doesn't unlock features or remove paywalls. It changes who sees you. A user who's completed three dates and left feedback on each will appear more often in compatible-intent users' feeds than a user who's matched ten times and never met anyone. The same applies in reverse — visibility throttles, quietly, when the behavior is scroll-only.
...
Chem IRL solved the spreadsheet problem differently. The product economics don't depend on holding you here. We earn from a small token system — used for things like unblocking expired matches, almost never used by users who are actively dating well — and from optional features that are gated behind behavior, which means they're only available to users who are already showing up. The business model and the user goal point in the same direction. Read more about what the gate covers and doesn't cover in [the post on why money can't buy visibility](/blog/dating-app-you-cant-pay-to-rank-on).
...
We give up the easy-to-explain feature comparison. "We have unlimited swipes" is a thing other apps say in their marketing. "Discovery is shaped around what you actually do — including whether you go on dates" is harder to fit on a billboard. We bet that the right users — the ones who care about the second sentence — will find us anyway.
