...
faq:
  ...
  - question: "What happens if you don't know what you want yet?"
    answer: "You can use the product, but the defaults will feel like friction. Match expiry, the proposal flow, the prompts that ask for specifics — these all assume you've made a decision. If you haven't, the system isn't going to make it for you. The fastest way to get the app to feel right is to figure out what you actually want from dating right now, even if the answer is 'I'm not sure, I want to find out.' That's a clarity, too."
