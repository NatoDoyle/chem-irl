...
We declined to take the contradiction on. The business model has no ad revenue. The paid surface is a small set of paid utilities. Adding a feed, an in-app stories surface, or a creator program would require rebuilding the business model — which we won't do, because the current one is the entire point.
