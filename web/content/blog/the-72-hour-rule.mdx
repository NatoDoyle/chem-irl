...
The product is built to land on a median of **6 days** from match to in-person date — not 6 weeks. That's the number we're optimizing for. Everything else is in service of it.
