...
> **TL;DR.** Chem IRL makes flaking expensive. Every cancellation, no-show, and ghosted active thread leaves a trace in your Seriousness Score, which controls how often you're shown to other users. Reliable daters earn reputation badges that surface their follow-through publicly. The cost of bad behavior is measured in the matches a flaker will never see — and the upside of showing up shows up the same way.
