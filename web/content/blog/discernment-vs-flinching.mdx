...
tags:
  ...
  - self-erasure
category: advice
primaryQuestion: "How do you tell a real red flag from being triggered?"
secondaryQuestions:
  - "Why does discernment expand and flinching contract?"
  - "What four questions tell discernment from flinching?"
  - "What do you do when you can't tell?"
  - "Why does flinching feel like discernment?"
entities:
  - "discernment vs flinching"
  - "the four-question check"
tldr: "Most of the time you can't tell whether something is a red flag or a trigger, you're being triggered. Discernment expands the situation; flinching contracts it to a verdict. Discernment is paced, tolerates not knowing; flinching is an emergency that needs the verdict now. The four-question check: is the certainty bigger than the evidence, where do you feel it, does it match a date in your past, what does waiting an hour do?"
...
faq:
  - question: "Why does discernment expand and flinching contract?"
    answer: "Discernment makes the situation bigger and more textured — here's what I see, here's what I don't see yet, here's a question I could ask. Flinching makes the situation smaller and final — here's what this is, here's what it means, here's the one move that's left. Discernment is paced; it tolerates not knowing for an hour or three days. Flinching is an emergency that needs the verdict now."
  - question: "What four questions tell discernment from flinching?"
    answer: "One: is the certainty bigger than the evidence? Two: where are you feeling it in the body — discernment lives quiet (sternum, exhale), flinching is sharper (jaw, neck, ribs going small). Three: does this feeling match a date in your past? Flinches have origin stories. Four: what does waiting an hour do? Discernment gets clearer; flinching escalates. They take ninety seconds."
  - question: "What do you do when you can't tell?"
    answer: "Don't act yet. Don't send the text, cancel the date, or draft the breakup. Sit with the not-knowing for an hour, often two. Discernment, given time, sharpens. Flinching, given time, fades on its own — the urgency draining out. If after that the read is still murky, ask one question of the actual person, not the group chat. Watch what their answer does to the feeling."
  - question: "Why does flinching feel like discernment?"
    answer: "Because vocabulary makes the trick hard to catch. *I just have a feeling about this. I'm just being honest with myself. I'm just protecting my peace.* Sometimes those sentences mean what they say; sometimes they're the wound firing, wearing therapy clothes. Real discernment uses the answer to update the situation; flinching adjusts to absorb it without changing — certainty intact, goalposts moved."
citableClaim: "Most of the time you can't tell whether something is a red flag or a trigger, you're being triggered. Real discernment comes from peace; flinching comes from old fear in your nervous system, dressed up in adult vocabulary so it doesn't trip the alarm."
draft: false
---
...
## When you can't tell, are you probably flinching?

Yes — and that's the bad news at the center of this question. There's a piece of bad news at the center of this question.
