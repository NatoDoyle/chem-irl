...
export function Nav() {
  ...
  return (
    <>
      ...
      {/* Mobile menu overlay - sibling of <nav> so the nav's backdrop-filter
          doesn't become this overlay's containing block (which would collapse
          its inset-0/top-16 box to the nav's 64px height and erase the bg). */}
      {mobileOpen && (
