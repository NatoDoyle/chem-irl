...
-- Migrated from: db/auth_otp_migration.sql
-- Order: 6 of 12
-- Description: Adds columns for OTP-based authentication flow
...
-- Note: Profiles auto-creation is handled by trigger in 20240107000000_profiles_auto_create_trigger.sql
