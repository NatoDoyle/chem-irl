...
-- Migrated from: db/security_fixes.sql
-- Order: 5 of 12
-- Description: Adds authorization checks to prevent unauthorized data access/modification
-- Note: Must run after db/rls.sql and db/scoring.sql
